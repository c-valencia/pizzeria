/** 
 * Nombre del Archivo: SalsaJpaController.java 
...
public class DaoSalsa implements Serializable {

    public DaoSalsa(EntityManagerFactory emf) {
        this.emf = emf;
    }
